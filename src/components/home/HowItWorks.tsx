...
const steps = [
  { number: '01', title: 'Live Enablement Call', time: '1 hr / month' },
  { number: '02', title: 'Self-Paced Modules', time: '3 hrs / month' },
  { number: '03', title: 'Knowledge Check', time: 'End of month' },
  { number: '04', title: 'Progress Report', time: 'Delivered to client' },
  { number: '05', title: 'Hands-On Support', time: 'As needed' },
]
      ...
      <div className="section-container">
        ...
        <div className="hidden lg:block">
          <div className="relative">
            <div className="absolute top-7 left-[10%] right-[10%] h-px bg-stone-200" />
            <div className="grid grid-cols-5 gap-0">
              {steps.map((step, i) => (
                ...
                >
                  ...
                  <span className="font-mono text-[10px] text-brand-700 uppercase tracking-[0.12em]">
                    {step.time}
                  </span>
                </div>
              ))}
        ...
        <div className="lg:hidden">
          {steps.map((step, i) => (
            ...
            >
              ...
              <div className="pb-6">
                <h3 className="text-sm font-semibold text-stone-900 mb-0.5">{step.title}</h3>
                <span className="font-mono text-[10px] text-brand-700 uppercase tracking-[0.12em]">
                  {step.time}
                </span>
              </div>
